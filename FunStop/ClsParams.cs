...
namespace FunStop
{
    public class ClsParams
    {
        ...
        public ClsParams(String objNombre, Object objValor)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
        ...
        public ClsParams(String objNombre, Object objValor, SqlDbType objTipoDato, ParameterDirection objDireccion, int objTamaño)
        {
            m_Nombre = objNombre;
            m_Valor = objValor;
